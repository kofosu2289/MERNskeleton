  ...
  render() {
    return (
      <div>
       ...
       {this.state.tab === 1 && <TabContainer><FollowGrid people={this.props.user.followers}/></TabContainer>}	       {this.state.tab === 1 && <TabContainer><FollowGrid people={this.props.user.following}/></TabContainer>}
